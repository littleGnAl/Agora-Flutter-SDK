import 'package:agora_rtc_engine_example/examples/basic/join_channel_video/join_channel_video_token.dart';
...
final basic = [
  ...
  {'name': 'JoinChannelVideoToken', 'widget': const JoinChannelVideoToken()}
];
